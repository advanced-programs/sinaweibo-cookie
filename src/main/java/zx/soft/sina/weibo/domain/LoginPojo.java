...
public class LoginPojo implements Serializable {
	...
	private static final long serialVersionUID = -7828421507947386326L;
	...
	/** full constructor */
	public LoginPojo(Integer id, String uid, String username, String password, String status, String type) {
		this.id = id;
		this.uid = uid;
		this.username = username;
		this.password = password;
